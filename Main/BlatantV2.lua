...
local fishing = {
    ...
    TotalFish = 0,
    Settings = {
        FishingDelay = 0.90,      -- Dikurangi dari 0.3 ke 0.05
        CancelDelay = 0.90,       -- Dikurangi dari 0.05 ke 0.01
        HookWaitTime = 0.95,    -- Dikurangi dari 0.30 ke 0.15
        CastDelay = 0.095,         -- Dikurangi dari 0.07 ke 0.03
        TimeoutDelay = 0.5,       -- Dikurangi dari 1.1 ke 0.8
    },
}
...
RE_FishCaught.OnClientEvent:Connect(function(name, data)
    if fishing.Running then
        ...
        log("🐟 #" .. fishing.TotalFish .. ": " .. tostring(name))
